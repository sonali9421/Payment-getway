...
public class PayuMoneyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void restoreAppPref() {
        ...
        } else if (AppPreference.selectedTheme == R.style.AppTheme_pink) {
            radio_btn_theme_pink.setChecked(true);

        } else if (AppPreference.selectedTheme == R.style.AppTheme_Grey) {
            radio_btn_theme_grey.setChecked(true);

        } else if (AppPreference.selectedTheme == R.style.AppTheme_purple) {
            radio_btn_theme_purple.setChecked(true);

        } else if (AppPreference.selectedTheme == R.style.AppTheme_Green) {
    ...
    private void initListeners() {
        ...
        radioGroup_select_env.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, @IdRes int i) {
                if (i == R.id.radio_btn_sandbox) {
                    selectSandBoxEnv();

                } else if (i == R.id.radio_btn_production) {
                    selectProdEnv();
